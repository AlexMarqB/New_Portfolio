export const ptBR = {
	...
	about: {
		...
		text2: "Estou seguindo o stack do Typescript, com NextJS (o framework utilizado para este portfólio), NodeJS para APIs, PostgreSQL e Oracle para banco de dados, e React Native para desenvolvimento móvel nativo. Mesmo possuindo esse conhecimento, estou sempre buscando mais e mais, aprimorando minhas habilidades de clean code, arquitetura, tecnologias, frameworks, metodologias e habilidades interpessoais, buscando me tornar um desenvolvedor inteligente tanto nas soft skills quanto nas hard skills, capaz de trabalhar em equipes e, futuramente, liderá-las.",
	},
	services: {
		title: "Conhecimentos",
		next: {
	...
	projects: {
		...
		daily_diet: {
			title: "Daily Diet",
			desc: "Um aplicativo para ajudar você a controlar sua dieta diária."
		},
		find_friend: {
			title: "Find a Friend",
